...
test("learner API exposes profile, enrolment, assignment, delivery, attempts, responses and progress contracts", () => {
  ...
  for (const method of ["getProfile", "ensureLearnerAuthLink", "getEnrolments", "getAssignments", "getHubAssignments", "resolveLearnerHubAccess", "getCurriculumDelivery", "getAttempts", "getResponses", "getProgress", "getActivityState", "saveActivityState", "clearActivityState", "getRegistrationOptions", "completeOnboarding", "joinLearnerHubGroup", "submitAttempt", "markFormativeResponse", "getPublishedCurriculum", "getPublishedCurriculumPackage"]) {
